...
# These are sample keys only
# Generate your keys and IV with GenerateEncryptionKeys.py
# secrets.py deployed to all devices (Including Wifi)
# secretsHouse.py deployed to all wifi device
